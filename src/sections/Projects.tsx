			...
			<div className='container'>
				...
				<div className='flex flex-col mt-10'>
					{portfolioProjects.map((project) => (
						...
						>
							<div className='flex'>
								<div className='bg-gradient-to-r from-emerald-300 to-sky-400 text-center text-transparent bg-clip-text inline-flex font-bold uppercase tracking-widest text-sm'>
