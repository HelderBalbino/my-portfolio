	...
	return (
		<section className='pb-16'>
			<div className='container'>
				...
				<p className='text-center md:text-lg text-white/60 mt-6 max-w-md mx-auto'>
				...
				<div className='flex flex-col gap-28 mt-10 md:mt-20'>
					{portfolioProjects.map((project) => (
						<div
							key={project.title}
							className='bg-gray-800 rounded-3xl relative z-0 overflow-hidden after:z-10 after:content-[""] after:absolute after:inset-0 after:outline-2 after:outline after:-outline-offset-2 after:rounded-3xl after:outline-white/20 px-8 pt-8 md:pt-12 after:pointer-events-none'
						>
							<div
