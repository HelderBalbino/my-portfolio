...
const testimonials = [
	{
		...
		text: "'I had the pleasure of working with Helder during the Tech Native Digital Web Development Bootcamp. He is easy-going, communicative, and a great team player. Working with him was always smooth and productive, brings a positive attitude and collaborates well with others. I’m confident he will be a valuable asset to any team I’m excited to see where Helder takes his skills next. With his focus and determination, I have no doubt he’ll make a valuable impact wherever he goes.'",
